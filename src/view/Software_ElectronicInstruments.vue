<template>
  <div id="Software">
    ...
    <div class="page-header">
      <h1>多路输出电源通用测试系统 <small>电子设备测试仪器</small></h1>
    </div>
    ...
    <div class="row platform-intro">
      ...
      <div class="col-md-12">
        <h2>设备概述</h2>
        <p style="text-indent: 2em;"><strong>作为一款造型小巧，制作精良的，多路输出通用测试系统，该产品有着以下特点和显著的优势 ：</strong></p>
    ...
    <div class="application-scenarios">
      ...
      <div class="row">
        ...
        <div class="col-md-4 text-center">
          ...
          <h3>多个电源测试</h3>
          <p>支持在“单一电源”基础上，连接多个电源,对其进行测试和试验</p>
        </div>
        <div class="col-md-4 text-center">
          <div class="advantage-icon">
