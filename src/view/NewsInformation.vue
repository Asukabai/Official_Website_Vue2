      ...
      <ul v-show="activeTab==='大事记'" class="news-container container-fuild">
        <li v-for="(item,index) in newsList" :key="index" class="wow fadeIn">
          <div class="content">
            ...
            <p style="text-indent: 2em;">{{item.introduce}}</p>
          </div>
          <div class="time">
            <p>{{item.date}}</p>
            <span>{{item.year}}</span>
      ...
      <div v-show="activeTab==='资质成果'" class="container">
        <div class="row innovation-container">
          ...
          <div class="col-xs-12 col-sm-12 col-md-6">
            <h3 class="text-center">陕西晟思智能测控有限公司</h3>
            <p class=".text-justify" style="text-indent: 2em;">陕西晟思智能测控有限公司成立于2015年，是一家专注于自动化测控与智能制造领域，且已纳入军工配套体系，以军工品质为理念，全面贯彻并通过了质量管理体系认证的高新技术企业。公司长期致力于力性能与电性能测控技术的研发与应用，核心产品涵盖自动化测控系统、负载模拟系统、超高速/高压电子负载、仿真测试平台、视觉自动化检测与图像识别系统、高精度传感器、EHA液压设备等，广泛应用于航天、航空、军工、能源、核工业、船舶及智能实验室等高精尖行业。 晟思智能以"机、电、控、软一体化"为技术方向，为高端制造客户提供智能化的整体解决方案，助力产业升级与技术创新。公司先后获得国家高新技术企业、陕西省"专精特新"企业、省市"瞪羚企业"、软件企业认定，并被评为陕西省AAA级信誉单位、西咸新区"双创之星"等多项荣誉，具备完善的质量管理体系认证和持续的创新能力，以领先技术和可靠服务赢得行业信赖。</p>
          </div>
        </div>
      ...
      newsList:[
        {
          id: '001',
          title: '公司成立十周年"',
          introduce: '十周年，从人员规模不断扩大到关键技术持续积累突破。它见证了公司从初创到壮大的奋斗历程，承载着所有员工的汗水与智慧，凝聚了客户与伙伴的长期信任；',
          date: '07-07',
          year: '2025'
        },
        {
        ...
        },
        {
          id: '003',
          title: '荣获陕西省 "瞪羚企业" ',
          introduce: '由陕西省科学技术厅颁发的"瞪羚企业"证书，是对公司卓越成长性与强大创新实力的权威认证。这份荣誉代表着政府部门对我们高速成长性和创新潜力的高度认可；',
          date: '10-18',
          year: '2024'
        },{
          id: '004',
          title: '获陕西省 "专精特新" 企业',
          introduce: '"专精特新"认定，表明公司在细分领域的技术实力、产品质量处于较高水平，是企业核心竞争力的体现。充分肯定了我们在专业化、精细化、特色化发展道路上取得的成效；',
          date: '04-02',
          year: '2023'
        },{
          id: '005',
          title: '获陕西省 "秦创原优秀科创" 企业',
          introduce: '标志着公司发展模式和质量获得了政府与市场认可，是对我司专业化发展的权威认证。作为秦创原优秀科技创新企业，我们将继续为推动区域科技创新和产业升级作出更大贡献；',
          date: '07-02',
          year: '2022'
        },{
          id: '006',
          title: '荣获陕西省"最佳创新软件企业"',
          introduce: '充分证明了我司的技术路线、研发体系及创新成果获得了政府与行业的广泛认可，极大地提升了品牌在信息技术领域的专业形象与公信力；',
          date: '9-11',
          year: '2021'
        },{
          id: '007',
        ...
        },
        {
          id: '009',
          title: '国军标质量管理体系认证"',
          introduce: '荣获国军标（GJB 9001B-2009标准）质量管理体系认证，标志着公司发展走向了新阶段。充分证明了我们在产品质量、服务保障、过程管控等方面达到了军工标准严格要求；',
          date: '09-06',
          year: '2017'
        },
        {
