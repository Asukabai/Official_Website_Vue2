      ...
      <div v-show="activeTab==='资质成果'" class="container">
        <div class="row innovation-container">
          ...
          <div class="col-xs-12 col-sm-12 col-md-6">
            ...
            <p class=".text-justify" style="text-indent: 2em;">陕西晟思智能测控有限公司成立于2015年，是一家专注于自动化测控与智能制造领域，具备国军标质量管理体系认证、二级保密资质的高新技术企业。公司长期致力于力性能与电性能测控技术的研发与应用，核心产品涵盖自动化测控系统、负载模拟系统、超高速/高压电子负载、仿真测试平台、视觉自动化检测与图像识别系统、高精度传感器、EHA液压设备等，广泛应用于航天、航空、军工、能源、核工业、船舶及智能实验室等高精尖行业。 晟思智能以"机、电、控、软一体化"为技术方向，为高端制造客户提供智能化的整体解决方案，助力产业升级与技术创新。公司先后获得国家高新技术企业、陕西省"专精特新"企业、省市"瞪羚企业"、软件企业认定，并被评为陕西省AAA级信誉单位、西咸新区"双创之星"等多项荣誉，具备完善的质量管理体系认证和持续的创新能力，以领先技术和可靠服务赢得行业信赖。</p>
          </div>
        </div>
